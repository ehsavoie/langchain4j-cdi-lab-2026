...
- The following artifacts installed in your local Maven repository (not yet on Maven Central):
  - `dev.langchain4j.cdi:langchain4j-cdi-core:1.3.3`
  - `dev.langchain4j.cdi:langchain4j-cdi-portable-ext:1.3.3`
  - `dev.langchain4j.cdi.mp:langchain4j-cdi-config:1.3.3`
  - `dev.langchain4j:langchain4j-agentic:1.16.3`
  - `dev.langchain4j:langchain4j-agentic-a2a:1.16.3`
...
- **AI framework**: [LangChain4j 1.16.3](https://docs.langchain4j.dev/) with [langchain4j-cdi 1.3.3](https://github.com/langchain4j/langchain4j-cdi)
